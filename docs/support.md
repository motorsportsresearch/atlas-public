...
|----------------------|------------|------------------|----------|
| [OBDX Pro VX](https://obdxpro.com/product/obdx-pro-vx-obd2-diagnostics-and-tuning/) | Wired/Wireless<br>(Bluetooth 5.0 LE/USB-Micro B) | ![Supported](https://flat.badgen.net/badge/icon/Supported?label&color=green)<br>120Hz | ![Supported](https://flat.badgen.net/badge/icon/Supported?label&color=green)<br>(Wired: 20-30 seconds<br>Wireless: 60-80 seconds) |
